...
<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  <div class="w3-bar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
    ...
    <a href="learning-english.php" class="w3-bar-item w3-button" style="width:25% !important">LEARNING ENGLISH</a>
...
<h2 class="w3-text-light-grey w3-text-grey w3-center w3-cursive">~ BOOK RECOMMENDATIONS ~</h2>
...
<div class="w3-row-padding w3-padding-16 w3-center" id="book">
	...
	<?php
        ...
        while($book = mysqli_fetch_array($query)){
            echo "<tr>";?>
			<td><?php $book['id_book']?></td>
     <?php echo "<img src='pictures/".$book['image']."'style='width:200px; height:100px;'>"?>
