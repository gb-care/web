...
<div class="w3-display-container">
  <form action="crud3.php" enctype="multipart/form-data" method="post">
  <div class="row">
    <div class="col-25">
  ...
  <div class="w3-display-container">
   ...
   <p>    <tr>
        ...
        while($b = mysqli_fetch_array($query)){
            ...
            echo "<td>";
            echo "<a href='form-edit2.php?id_travel=".$b['id_travel']."'>Edit</a> | ";
            echo "<a href='hapus2.php?id_travel=".$b['id_travel']."'>Hapus</a>";
            echo "</td>";
