...
<div class="w3-padding-large" id="main">
  ...
  <!-- About Section -->
<h2 class="w3-cursive w3-center">~ TAJWID ~</h2>
...
<div class="w3-display-container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="fname" name="judul" required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="lname" name="tag" required>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-75">
      <textarea id="subject" name="content" style="height:200px" required></textarea>
    </div>
  </div>
    <br>
  <div class="row">
  ...
  <div class="w3-display-container">
   ...
   <p>    <tr>
        ...
        <?php
        $sql = "SELECT * FROM tajwid";
        $query = mysqli_query($koneksi, $sql);

        while($book = mysqli_fetch_array($query)){
            echo "<tr>";
			echo "<td>".$book['id_tajwid']."</td>";
            ...
            echo "<td>";
            echo "<a href='form-edit3.php?id_tajwid=".$book['id_tajwid']."'>Edit</a> | ";
            echo "<a href='hapus3.php?id_tajwid=".$book['id_tajwid']."'>Hapus</a>";
            echo "</td>";
