...
<div class="w3-padding-large" id="main">
  ...
  <!-- About Section -->
<h2 class="w3-cursive w3-center">~ LEARNING TAJWID ~</h2>
<?php
	include 'config.php';
	$id_tajwid = $_GET['id_tajwid'];
	$data = mysqli_query($koneksi,"select * from tajwid where id_tajwid='$id_tajwid'");
...
<div class="w3-display-container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="hidden" id="id" name="id_tajwid" value="<?php echo $d['id_tajwid']; ?>" required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
