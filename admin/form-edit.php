...
<div class="w3-padding-large" id="main">
  ...
  <!-- About Section -->
<h2 class="w3-cursive w3-center">~ Learning English ~</h2>
<?php
	include 'config.php';
	$id_english = $_GET['id_english'];
	$data = mysqli_query($koneksi,"select * from english where id_english='$id_english'");
...
<div class="w3-display-container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="hidden" id="id" name="id_english" value="<?php echo $d['id_english']; ?>" required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
