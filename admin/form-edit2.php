...
<div class="w3-padding-large" id="main">
  ...
  <!-- About Section -->
<h2 class="w3-cursive w3-center">~ TRAVELLING GUIDE ~</h2>
<?php
	include 'config.php';
	$id_travel = $_GET['id_travel'];
	$data = mysqli_query($koneksi,"select * from travel where id_travel='$id_travel'");
...
<div class="w3-display-container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="hidden" id="id" name="id_travel" value="<?php echo $d['id_travel']; ?>" required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="fname" name="judul" value="<?php echo $d['judul']; ?>" required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="lname" name="tag" value="<?php echo $d['tag']; ?>" required>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-75">
       <textarea id="subject" name="content" style="height:200px"  ><?php echo $d['content'] ?></textarea>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-75">
 	 ...
 	 <input type="file" id="img" name="image" accept="image/*" value="<?php echo $d['image']; ?>">
    </div>
  </div>
    <br>
  <div class="row">
