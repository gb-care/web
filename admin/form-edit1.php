...
<div class="w3-padding-large" id="main">
  ...
  <!-- About Section -->
<h2 class="w3-cursive w3-center">~ BOOK RECOMMENDATIONS ~</h2>
<?php
	include 'config.php';
	$id_book = $_GET['id_book'];
	$data = mysqli_query($koneksi,"select * from book where id_book='$id_book'");
...
<div class="w3-display-container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="hidden" id="id" name="id_book" value="<?php echo $d['id_book']; ?>" required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
